      ...
      <div class="formContainer col d-flex justify-content-start flex-column">
        <div class="formCont">
          ...
          >
            ...
            <option v-for="(min, index) in minerales" :key="index" :value="min.mineral">
              {{ min.mineral }}
            </option>
          </select>
        </div>
        <div class="formCont">
          ...
          <input
            ...
            class="form-control"
            id="cantidad"
            :placeholder="cantExplotar"
            v-model="cantExplotar"
          />
        </div>
      </div>
      <div class="formContainer col d-flex justify-content-start flex-column">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="(elm, index) in pozos" :key="index" style="text-align: center">
                <td>{{ elm.id }}</td>
                <td>{{ elm.capacidad }}</td>
                <td v-show="pozo.length == 0">
                  <button @click="handleClickGetPozo(elm)" class="btn">Seleccionar</button>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="(elm, index) in pozo" :key="index" style="text-align: center">
                ...
                <td>{{ elm.capacidad }}</td>
                <td>
                  <button @click="handleClickEliminarPozo(index)" class="btn">Eliminar</button>
                </td>
              </tr>
            </tbody>
          </table>
